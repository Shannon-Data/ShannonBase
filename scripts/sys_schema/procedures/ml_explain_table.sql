...
DROP PROCEDURE IF EXISTS sys.ml_explain_table;

DELIMITER $$

CREATE DEFINER='mysql.sys'@'localhost' PROCEDURE sys.ml_explain_table (
...
Run the ml_explain_table routine on a labeled training dataset to produce a trained machine learning model.
...
mysql> CALL sys.ml_explain_table(\'ml_data.iris_train\', \'class\', 
