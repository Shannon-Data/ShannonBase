...
DROP PROCEDURE IF EXISTS sys.ml_predict_table;

DELIMITER $$

CREATE DEFINER='mysql.sys'@'localhost' PROCEDURE sys.ml_predict_table (
...
Run the ml_predict_table routine on a labeled training dataset to produce a trained machine learning model.
...
mysql> CALL sys.ml_predict_table(\'ml_data.iris_train\', \'class\', 
