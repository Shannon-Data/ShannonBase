...
Run the ML_MODEL_UNLOAD routine to unload a model.
...
BEGIN
   ...
   IF v_model_meta IS NULL THEN
     SIGNAL SQLSTATE 'HY000'
        SET MESSAGE_TEXT = "The model you unloading does NOT exist.";
   END IF;

   SELECT ML_MODEL_UNLOAD(in_model_handle_name, v_model_meta) INTO v_train_obj_check;
