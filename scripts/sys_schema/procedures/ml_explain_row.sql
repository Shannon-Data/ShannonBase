...
DROP PROCEDURE IF EXISTS sys.ml_explain_row;

DELIMITER $$

CREATE DEFINER='mysql.sys'@'localhost' PROCEDURE sys.ml_explain_row (
...
Run the ml_explain_row routine on a labeled training dataset to produce a trained machine learning model.
...
mysql> CALL sys.ml_explain_row(\'ml_data.iris_train\', \'class\', 
