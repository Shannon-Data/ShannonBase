...
DROP PROCEDURE IF EXISTS sys.ml_predict_row;

DELIMITER $$

CREATE DEFINER='mysql.sys'@'localhost' PROCEDURE sys.ml_predict_row (
...
mysql> CALL sys.ml_predict_row(\'ml_data.iris_train\', \'class\', 
