...
#ifndef MYSQLD_RAPID_RAPID_SESSION_INCLUDED
#define MYSQLD_RAPID_RAPID_SESSION_INCLUDED
...
class MySQLServerRapidSession {
 public:
  MySQLServerRapidSession(
  ...
  virtual ~MySQLServerRapidSession() = default;
...
#endif  // MYSQLD_RAPID_RAPID_SESSION_INCLUDED
