...
#ifndef MYSQLD_RAPID_MYSQL_SERVER_RAPID_INCLUDED
#define MYSQLD_RAPID_MYSQL_SERVER_RAPID_INCLUDED
...
class MySQLServerRapid {
 public:
   ...
   *                        connections
   * @param protocol the protocol this rapid instance speaks: "x" or "classic"
   ...
   */
  MySQLServerRapid(net::io_context &io_ctx, std::string expected_queries_file,
...
#endif  // MYSQLD_RAPID_MYSQL_SERVER_RAPID_INCLUDED
