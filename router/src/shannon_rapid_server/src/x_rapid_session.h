...
#ifndef MYSQLD_RAPID_X_RAPID_SESSION_INCLUDED
#define MYSQLD_RAPID_X_RAPID_SESSION_INCLUDED
...
#include "router/src/shannon_rapid_server/src/rapid_session.h"
...
class MySQLServerRapidSessionX : public MySQLServerRapidSession {
 public:
  using clock_type = std::chrono::steady_clock;

  MySQLServerRapidSessionX(
...
#endif  // MYSQLD_RAPID_X_RAPID_SESSION_INCLUDED
