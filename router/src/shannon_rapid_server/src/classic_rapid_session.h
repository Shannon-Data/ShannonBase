...
#ifndef MYSQLD_RAPID_CLASSIC_RAPID_SESSION_INCLUDED
#define MYSQLD_RAPID_CLASSIC_RAPID_SESSION_INCLUDED
...
class MySQLServerRapidSessionClassic : public MySQLServerRapidSession {
 public:
  MySQLServerRapidSessionClassic(
