...
{
  "title": "MySQL Server Rapid Data",
      "description": "JSON Schema of the input files of the mysql-server-rapid",
      ...
      "definitions": {
        ...
        "ResultsetColumn": {
          ...
          "properties": {
            ...
            "comment": {
              "description":
                  "additional information/comment about the column; ignored by the server rapid, for self-documenting only",
              "type": "string"
            },
            "repeat": {
              "description":
      ...
      "properties": {
        ...
        "stmts": {
          "description":
              "RPCs that the rapid will expect and process one after the other",
          "type": "array",
