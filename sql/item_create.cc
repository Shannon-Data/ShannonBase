...
static const std::pair<const char *, Create_func *> func_array[] = {
    ...
    {"ML_MODEL_ACTIVE", SQL_FN_ODD(Item_func_ml_active, 1, 2)},
    {"ML_MODEL_TRAIN", SQL_FN_V_LIST(Item_func_ml_train, 5, 6)},
    {"ML_MODEL_LOAD", SQL_FN(Item_func_ml_model_load, 1)},
    {"ML_MODEL_UNLOAD", SQL_FN(Item_func_ml_model_unload, 1)},
    {"ML_MODEL_IMPORT", SQL_FN(Item_func_ml_model_import, 3)},
    {"ML_MODEL_SCORE", SQL_FN_V_LIST(Item_func_ml_score, 5, 6)},
    {"ML_MODEL_PREDICT_ROW", SQL_FN_ODD(Item_func_ml_predicte_row, 3, MAX_ARGLIST_SIZE)},
    {"ML_MODEL_PREDICT_TABLE", SQL_FN_V_LIST(Item_func_ml_predicte_table, 3, 4)},
    {"ML_MODEL_EXPLAIN", SQL_FN_V_LIST(Item_func_ml_explain, 3, 4)},
    {"ML_MODEL_EXPLAIN_ROW", SQL_FN_V_THD(Item_func_ml_explain_row, 2, 3)},
    {"ML_MODEL_EXPLAIN_TABLE", SQL_FN_V_LIST(Item_func_ml_explain_table, 3, 4)},
    {"ML_MODEL_EMBED_ROW", SQL_FN_V_LIST(Item_func_ml_embed_row, 1, 2)},
    {"ML_MODEL_EMBED_TABLE", SQL_FN_V_LIST(Item_func_ml_embed_table, 2, 3)},
    {"ML_MODEL_GENERATE", SQL_FN_V_LIST(Item_func_ml_generate, 1, 2)},
    {"ML_MODEL_GENERATE_TABLE", SQL_FN_V_LIST(Item_func_ml_generate_table, 2, 3)},
    {"ML_RAG", SQL_FN_V_LIST(Item_func_ml_rag, 2, 3)},
    ...
    {"DISTANCE", SQL_FN_V_LIST(Item_func_vector_distance, 3, 3)},
