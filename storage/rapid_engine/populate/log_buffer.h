...
#ifndef __SHANNONBASE_LOG_BUFFERS_H__
#define __SHANNONBASE_LOG_BUFFERS_H__
...
class Ringbuffer {
 public:
   ...
   * code when object is instantiated in .bss section \warning If object is
...
#endif  //__SHANNONBASE_LOG_BUFFERS_H__