...
constexpr uint64 SHANNON_TABLE_MEMRORY_SIZE = 256 * SHANNON_MB;
constexpr uint64 SHANNON_SMALL_TABLE_MEMRORY_SIZE = 128 * SHANNON_MB;
constexpr uint64 SHANNON_MAX_MEMRORY_SIZE = SHANNON_DEFAULT_MEMRORY_SIZE;
constexpr uint64 SHANNON_MAX_IMCU_MEMRORY_SIZE = 64 * SHANNON_MB;
