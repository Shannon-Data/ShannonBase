...
class ML_recommendation : public ML_algorithm {
 public:
  ML_recommendation() = default;
  virtual ~ML_recommendation() override = default;
  int train(THD *thd, Json_wrapper &, Json_wrapper &) override;
  ...
  ML_TASK_TYPE_T type() override { return ML_TASK_TYPE_T::RECOMMENDATION; }
